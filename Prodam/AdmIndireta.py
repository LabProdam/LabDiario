...
class SearchAdmIndireta(DlSearch):
	...
	def SetOptions(self):		
		...
		self.options["f[tipo_conteudo_facet][]"] = "DESPACHO"

class ProcessorAdmIndireta(ResponseProcessor):
	def __init__(self, configInstance, searchObject, parseObject, fileName, sessionName):
		super(ProcessorAdmIndireta, self).__init__(configInstance, searchObject, parseObject, sessionName)
